...
public  record ResponseCode(String message, int stateCode) {


    public ResponseCode(String message, int stateCode) {
    ...
    public static final int EMAIL_NOT_PROVIDED = 1102;
    /**
    ...
    public static final int USERNAME_NOT_FOUND = 1303;
    public static final int USERNAME_NOT_PROVIDED = 1304;
    public static final int USERNAME_EXISTS = 1305;
    ...
    public static final int PASSWORD_NOT_PROVIDED = 1404;
